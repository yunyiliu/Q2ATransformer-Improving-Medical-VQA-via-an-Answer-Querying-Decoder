...
parser.add_argument('--base_dir_path', type=str, default=r'/root/VQA_Main/Modified_MedVQA-main/data/path_VQA/images', help="")
parser.add_argument('--base_dir', type=str, default=r'/root/VQA_Main/Modified_MedVQA-main/data/VQA_RAD_Images', help="")
