...
class Transformer(nn.Module):
    ...
    def forward(self, src, query_embed, pos_embed=None, mask=None):
        ...
        bs, h, c = src.shape
        src = src.permute(1, 0, 2)  #[4, 69, 768] - [4, 768, 69] - [69, 4, 768]
        ...
        attention_map = hs.transpose(1, 2)
        return hs.transpose(1, 2), memory[:h].permute(1, 0, 2)
...
class TransformerEncoderLayer(nn.Module):
    ...
    def forward_post(self,
                     ...
                     src_key_padding_mask: Optional[Tensor] = None,
                     pos: Optional[Tensor] = None):
        q = k = self.with_pos_embed(src, pos) #69, 4, 768
        src2, corr = self.self_attn(q, k, value=src, attn_mask=src_mask,
                              key_padding_mask=src_key_padding_mask)
        
        attention_map_encoder = src2
